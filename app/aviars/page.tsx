      ...
      <section className="py-20 md:py-28 bg-[#0a0a0a]">
        <div className="site-container">
          <div className="max-w-5xl space-y-6">
            <p className="text-[#00ff41] uppercase tracking-[0.2em] text-xs font-semibold">Software Architecture</p>
      ...
      <section className="py-20 md:py-28 bg-[#0a0a0a]">
        <div className="site-container">
          <div className="mb-12 space-y-6">
            <p className="text-[#00ff41] uppercase tracking-[0.2em] text-xs font-semibold">Capabilities Deep Dive</p>
            <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">Engineered for absolute air superiority.</h2>
          </div>

          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            {/* Capability 1 */}
            <div className="bg-[#141414] border border-white/10 p-8 md:p-10 rounded-lg hover:border-[#00ff41]/40 transition-all duration-300">
              <div className="w-10 h-10 bg-[#00ff41]/10 border border-[#00ff41]/30 rounded flex items-center justify-center text-[#00ff41] font-mono text-sm font-bold mb-6">
                01
              </div>
              <h3 className="text-xl font-bold text-white mb-6">Real-Time Sensor Fusion</h3>
            ...
            <div className="bg-[#141414] border border-white/10 p-8 md:p-10 rounded-lg hover:border-[#00ff41]/40 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-white mb-6">Autonomous Target Tracking</h3>
              <p className="text-white/65 text-sm leading-relaxed">
            ...
            <div className="bg-[#141414] border border-white/10 p-8 md:p-10 rounded-lg hover:border-[#00ff41]/40 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-white mb-6">Signal Encryption &amp; Hardened Uplink</h3>
              <p className="text-white/65 text-sm leading-relaxed">
            ...
            <div className="bg-[#141414] border border-white/10 p-8 md:p-10 rounded-lg hover:border-[#00ff41]/40 transition-all duration-300">
              ...
              <h3 className="text-xl font-bold text-white mb-6">Edge AI Processing</h3>
              <p className="text-white/65 text-sm leading-relaxed">
        ...
        <div className="site-container">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-6">
              <div>
                <p className="text-[#00ff41] uppercase tracking-[0.2em] text-xs font-semibold mb-6">Dual Operational Functions</p>
                <h2 className="text-3xl sm:text-4xl font-bold text-white leading-tight tracking-tight">
                  From Stealth Reconnaissance to Precision Engagement.
                </h2>
              </div>
              <div className="space-y-6 pt-2">
                <div className="border-l-2 border-[#00ff41] pl-6 py-1">
                  <h4 className="text-[#00ff41] font-bold text-base mb-1 uppercase tracking-wider">1. Reconnaissance Mode (ISR)</h4>
                ...
                <div className="border-l-2 border-red-600 pl-6 py-1">
                  <h4 className="text-red-500 font-bold text-base mb-1 uppercase tracking-wider">2. Attack &amp; Kinetic Guidance Mode</h4>
                  <p className="text-white/70 text-sm leading-relaxed">
      ...
      <section className="py-20 md:py-28 bg-[#0a0a0a]">
        <div className="site-container">
          <div className="text-center max-w-2xl mx-auto mb-12 space-y-6">
            <p className="text-[#00ff41] uppercase tracking-[0.2em] text-xs font-semibold">Technical Specifications</p>
            <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">System Telemetry Benchmarks</h2>
          </div>
